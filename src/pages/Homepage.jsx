...
export default function TravelHomepage() {
    ...
    const [dateRange, setDateRange] = useState('Ultimo aggiornamento dati: 9 Gennaio 2026');
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-slate-50 to-blue-50">
            {/* Premium Header */}
            <header className="relative bg-linear-to-r from-blue-900 via-indigo-900 to-purple-900 text-white shadow-2xl">
                ...
                <div className="relative max-w-7xl mx-auto px-6 py-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button className="px-6 py-3 bg-linear-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg">
                                Search Flights
            ...
            {/* Hero Banner */}
            {!selectedCountry && (
                <div className="relative overflow-hidden bg-linear-to-br from-blue-600/10 to-purple-600/10">
                    <div className="max-w-7xl mx-auto px-6 py-12">
                        <div className="text-center max-w-3xl mx-auto">
                            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                                Find Your Perfect <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-600 to-purple-600">Mediterranean</span> Getaway
                            </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                            {travelData.countries.map((country, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="absolute inset-0 bg-linear-to-br from-blue-600/90 to-purple-700/90 z-10"></div>
                                        ...
                                        {availableCities > 0 && (
                                            <div className="absolute bottom-0 left-0 right-0 h-1 bg-linear-to-r from-cyan-500 to-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
                                        )}
                                    </div>
                                );
                            })}
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="text-center py-6">
                            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-3">
                                Explore <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-600 to-purple-600">{selectedCountry.name}</span>
                            </h2>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="relative h-48 overflow-hidden">
                                                <div className="absolute inset-0 bg-linear-to-br from-blue-500 to-purple-600"></div>
                                            ...
                                            <div className="p-6">
                                                ...
                                                <div className="mb-6">
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        {city.beaches.slice(0, 3).map((beach, i) => (
                                                            <span
                                                                key={i}
                                                                className="px-3 py-1.5 bg-linear-to-r from-blue-50 to-cyan-50 text-blue-700 rounded-full text-sm font-medium border border-blue-200"
                                                            >
                                                                {beach.name}
                                                            </span>
                                                        ))}
                                                ...
                                                <div className="pt-4 border-t">
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <button className="px-4 py-2 bg-linear-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300">
                                                            View Flights →
                                                        </button>
                                                    </div>
                                                </div>
                            ...
                            <div className="p-8">
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        {selectedCity.beaches.map((beach, idx) => (
                                            <div key={idx} className="bg-linear-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border border-blue-200">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                    ...
                                    <div className="bg-linear-to-br from-pink-50 to-orange-50 rounded-xl p-6 border border-pink-200">
                                        ...
                                        <div className="mb-4">
                                            <span className={`px-4 py-2 rounded-full font-semibold ${selectedCity.nightlife.rating === 'Molto vivace' || selectedCity.nightlife.rating === 'Leggendaria'
                                            ...
                                            <div className="p-6">
                                                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                                                    ...
                                                    <div className="flex-1 lg:text-right">
                                                        ...
                                                        <button className="w-full lg:w-auto px-8 py-3 bg-linear-to-r from-blue-600 to-purple-600 text-white font-bold rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg">
                                                            Book Now
                                                        </button>
                                                    </div>
                                                </div>
